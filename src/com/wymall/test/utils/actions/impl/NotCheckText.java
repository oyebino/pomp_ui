...
public class NotCheckText implements ActionType {
	...
	public void doAction(Map parms) {
		...
		seleniumUtil.isNotTextCorrect(seleniumUtil.getText(SuperAction.getLocateWay(locatorType, locatorValue)), testData);
	}
