...
public class CreateUserName implements ActionType {
	...
	public void doAction(Map parms) {
		...
		String username = "UIautotest" + seleniumUtil.randomNum(5);
		
		try {
			seleniumUtil.mem(founction, caseName, testData, username);
		} catch (IOException e) {
