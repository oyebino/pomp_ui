...
public class ExecuteJS_Click implements ActionType {
    /**
     * 动作：执行JS点击"
     *
     * @author alvis
    ...
    public void doAction(Map parms) {
        ...
        seleniumUtil.executeJSObj("arguments[0].click();", seleniumUtil.findElementBy(SuperAction.getLocateWay(locatorType, locatorValue)));
    }
