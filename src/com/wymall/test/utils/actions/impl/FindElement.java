...
public class FindElement implements ActionType {
	/**
	 * 动作："查找元素(尝试3次)" 
	 * @author alvis
	 *
	...
	public void doAction(Map parms) {
		...
		seleniumUtil.FindElementUtil3TimesTry(Integer.parseInt(testData), SuperAction.getLocateWay(locatorType, locatorValue));
	}
